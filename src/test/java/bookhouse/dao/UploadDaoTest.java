...
public class UploadDaoTest {
    ...
    public void listUploadByUserId() {
        System.out.println(uploadDao.listUploadThoughUserIdByBeginAndOffset(2, 1, 1));
    }

    @Test
    public void listUploadForAdmin() {
        System.out.println(uploadDao.getOneUploadByState("未处理"));
    }

    @Test
    public void updateState() {
        System.out.println(uploadDao.updateUploadStateById(2, "已处理"));
    }
}