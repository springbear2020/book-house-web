...
INSERT INTO `t_book` VALUES (NULL,'Java编程思想(第4版)','Bruce Eckel','陈昊鹏','Java 编程 计算机',0,0,'本书赢得了全球程序员的广泛赞誉，即使是最晦涩的概念，在Bruce Eckel的文字亲和力和小而直接的编程示例面前也会化解于无形。从Java的基础语法到最高级特性（深入的面向对象概念、多线程、自动项目构建、单元测试和调试等），本书都能逐步指导你轻松掌握。','WEB-INF/book/Java编程思想(第4版).pdf','static/picture/cover/Java编程思想(第4版).jpeg','bear','2022-03-22'),(NULL,'Java开发手册(嵩山版)','阿里巴巴','','Java 编程 规范',0,0,'Java开发手册来自万名阿里Java技术精英的经验总结，并经历了多次大规模一线实战检验及完善，铸就了这本高含金量的阿里Java开发手册。','WEB-INF/book/Java开发手册(嵩山版).pdf','static/picture/cover/Java开发手册(嵩山版).png','bear','2022-03-22'),(NULL,'Head First Java(第2版)','Kathy Sierra & Bert Bates','张然','Java 编程 计算机',0,0,'《HeadFirstJava》是一本完整地面向对象(object-oriented，OO)程序设计和Java的学习指导用书，根据学习理论所设计，你可以从程序语言的基础开始，到线程、网络与分布式程序等项目。','WEB-INF/book/Head First Java(第2版).pdf','static/picture/cover/Head First Java(第2版).jpg','bear','2022-03-22'),(NULL,'Java并发编程的艺术','方腾飞&魏鹏&程晓明','','Java 编程 计算机',0,0,'《Java并发编程的艺术》内容涵盖Java并发编程机制的底层实现原理、Java内存模型、Java并发编程基础、Java中的锁、并发容器和框架、原子类、并发工具类、线程池、Executor框架等主题，每个主题都做了深入的讲解，同时通过实例介绍了如何应用这些技术。','WEB-INF/book/Java并发编程的艺术.pdf','static/picture/cover/Java并发编程的艺术.png','bear','2022-03-22'),(NULL,'Java并发编程实战','Brian Goetz&Tim Peierls&Joshua Bloch&Joseph Bowbeer&David Holmes&Doug Lea','童云兰','Java 并发编程 计算机',0,0,'本书深入浅出地介绍了Java线程和并发，是一本完美的Java并发参考手册。书中从并发性和线程安全性的基本概念出发，介绍了如何使用类库提供的基本并发构建块，用于避免并发危险、构造线程安全的类及验证线程安全的规则，如何将小的线程安全类组合成更大的线程安全类，如何利用线程来提高并发应用程序的吞吐量，如何识别可并行执行的任务，如何提高单线程子系统的响应性，如何确保并发程序执行预期任务，如何提高并发代码的性能和可伸缩性等内容，最后介绍了一些高级主题，如显式锁、原子变量、非阻塞算法以及如何开发自定义的同步工具类。','WEB-INF/book/Java并发编程实战.pdf','static/picture/cover/Java并发编程实战.png','bear','2022-03-22'),(NULL,'Java核心技术卷I基础知识(原书第10版)','Cay S. Horstmann','周立新&陈波&叶乃文&邝劲筠&杜永萍','Java 编程 计算机',0,0,'本书由拥有20多年教学与研究经验的资深Java技术专家撰写（获Jolt大奖），是程序员的优选Java指南。本版针对Java SE 9、10和 11全面更新。','WEB-INF/book/Java核心技术卷I基础知识(原书第10版).pdf','static/picture/cover/Java核心技术卷I基础知识(原书第10版).png','bear','2022-03-22'),(NULL,'Thing in Java(Fourth Edition)','Bruce Eckel','','Java 编程 计算机',0,0,'本书赢得了全球程序员的广泛赞誉，即使是最晦涩的概念，在Bruce Eckel的文字亲和力和小而直接的编程示例面前也会化解于无形。从Java的基础语法到最高级特性（深入的面向对象概念、多线程、自动项目构建、单元测试和调试等），本书都能逐步指导你轻松掌握。','WEB-INF/book/Thing in Java(Fourth Edition).pdf','static/picture/cover/Thing in Java(Fourth Edition).png','bear','2022-03-22'),(NULL,'深入理解Java虚拟机JVM高级特性与最佳实践','周志明','','Java JVM 虚拟机 计算机',0,0,'这是一部从工作原理和工程实践两个维度深入剖析JVM的著作，是计算机领域公认的经典，繁体版在台湾也颇受欢迎。自2011年上市以来，前两个版本累计印刷36次，销量超过30万册，两家主要网络书店的评论近90000条，内容上近乎零差评，是原创计算机图书领域不可逾越的丰碑。','WEB-INF/book/深入理解Java虚拟机JVM高级特性与最佳实践.pdf','static/picture/cover/深入理解Java虚拟机JVM高级特性与最佳实践.png','bear','2022-03-22');
