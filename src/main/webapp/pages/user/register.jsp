...
<%--                // TODO 将此 span 标签右对齐，红色--%>
                <span class="registerErrorMsg">Msg:${empty requestScope.registerErrorMsg ? "" : requestScope.registerErrorMsg}</span>
                ...
                <div class="register-input"><label>
                    ...
                    <div class="little-tips">* 由字母、数字、下划线组成，长度为 1~15 且以字母开头</div>
                </label></div>
                ...
                <div class="register-input"><label>
                    ...
                    <div class="little-tips">* 由字母、数字、特殊字符组成，长度为 6~16</div>
                </label></div>
                ...
                <div class="register-input"><label>
                    ...
                    <div class="little-tips">* e.g bookhouse@bookhouse.com</div>
                </label></div>
