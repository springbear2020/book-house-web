...
<div class="middle">
  <div class="container">
    <div class="frame">
      <ul class="frame-title"><li class="title-pwdFind">忘记密码</li></ul>
        <div class="pwdFind">
            <form>
                <input class="input-text" placeholder="请输入账号" name="username">
                <div class="little-tips">×内容不能为空</div>
<%--                <button class="btn-next" onclick="javascript:window.location.href='verification.jsp'">下一步</button>--%>
